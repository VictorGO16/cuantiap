...
export function Sidebar({ modules, conceptsByModule }: SidebarProps) {
  ...
  return (
    <aside className="fixed top-0 left-0 h-screen w-sidebar bg-sidebar border-r border-border flex flex-col z-10">
      {/* Logo */}
      ...
      {/* Assistant button — dedicated section */}
        ...
        <button
          ...
          className={`
            ...
            ${isChatOpen
              ...
              : 'text-ink-muted border-border bg-white hover:text-ink hover:border-ink-faint hover:bg-white'
            }
          `}
        >
          <IconChat />
          ...
          {isChatOpen && (
            <span className="text-2xs opacity-60 font-normal">abierto</span>
          )}
        </button>
      </div>
